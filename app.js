...
function renderGrid() {
    ...
    products.forEach(product => {
        ...
        node.querySelector(".stamp-price").innerText = product.priceDisplay;
        node.querySelector(".card-title").innerText = product.title;
        node.querySelector(".card-eyebrow").innerText = product.category;
        node.querySelector(".card-desc").innerText = product.description;

        const image = node.querySelector(".card-swatch");
        ...
        node.querySelector(".card").onclick = function () {
...
function renderCart() {
    ...
    cartCountEl.innerText = Cart.totalCount();

    cartSubtotalEl.innerText = money(Cart.subtotalCents());
...
checkoutBtn.onclick = function () {
    ...
    if (!name || !phone || !address) {
        ...
        checkoutError.innerText = "Please complete your details";
    ...
    let message = "🛒 *NEW ORDER - SAAD STORE*\n\n";
